...
import { FitnessCenter, Height } from "@material-ui/icons";
        ...
        <Grid container spacing={3} justifyContent="space-between">
          ...
          <Grid item>
            <Avatar className={classes.avatar}>
              {(() => {
                if (prop.title === "Height") {
                  return <Height className={classes.avatar} />;
                } else if (prop.title === "Weight") {
                  return <FaWeight className={classes.avatar} />;
                } else {
                  return <FitnessCenter className={classes.avatar} />;
                }
              })()}
            </Avatar>
          </Grid>
