  ...
  async function loadModel() {
    ...
    try {
      ...
      model = await tf.loadLayersModel(
        `http://20.204.171.206:8080/${exercise}/model.json`
      );
    ...
    if (results.poseWorldLandmarks) {
      ...
      if (prob > 0.95) {
        drawingUtils.drawConnectors(
          ...
          { visibilityMin: 0.65, color: "rgb(10,255,0)" }
        );
        ...
        drawingUtils.drawConnectors(
          ...
          results.poseLandmarks,
          mpPose.POSE_CONNECTIONS,
          { visibilityMin: 0.65, color: "rgb(255,138,0)" }
        );
        drawingUtils.drawLandmarks(
          canvasCtx,
          Object.values(mpPose.POSE_LANDMARKS_LEFT).map(
          ...
          { visibilityMin: 0.65, color: "white", fillColor: "rgb(138,138,0)" }
        );
        drawingUtils.drawLandmarks(
          canvasCtx,
          Object.values(mpPose.POSE_LANDMARKS_RIGHT).map(
